...
function ProfileInfo() {
  ...
  const { userId, userIsOnline, setUserIsOnline, userBio, userPic, userBg, userCountry, setIsFriend } = useContext(ProfileContext);
  ...
  return (
    <>
      <GameNotifications userId={userId} setUserIsOnline={setUserIsOnline} setIsFriend={setIsFriend}/>
