                ...
                <div className='gameStats_container' >
                    <div className='gameStats_playerInfos' >
                        <div className='gameStats_playerInfos-details' >
                            <div>
                                {props.playersPics.length ? (<img onClick={() => profileImgClick(props.userName1)} src={`data:image/jpeg;base64,${props.playersPics[0].avatar}`} alt="" />) : (<img onClick={() => profileImgClick(props.userName1)} src={Icons.solidGrey} alt="" />)}
                                {props.playersPics.length ? (<img onClick={() => profileImgClick(props.userName2)}  src={`data:image/jpeg;base64,${props.playersPics[1].avatar}`} alt="" />) : (<img onClick={() => profileImgClick(props.userName2)} src={Icons.solidGrey} alt="" />)}
                            </div>
                            <div>
                                {props.playersPics.length ? (<img onClick={() => profileImgClick(props.userName3)} src={`data:image/jpeg;base64,${props.playersPics[2].avatar}`} alt="" />) : (<img onClick={() => profileImgClick(props.userName3)} src={Icons.solidGrey} alt="" />)}
                                {props.playersPics.length ? (<img onClick={() => profileImgClick(props.userName4)}  src={`data:image/jpeg;base64,${props.playersPics[3].avatar}`} alt="" />) : (<img onClick={() => profileImgClick(props.userName4)} src={Icons.solidGrey} alt="" />)}
                            </div>
                        </div>
                    </div>
