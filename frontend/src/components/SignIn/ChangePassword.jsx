				...
				<div className={styles["bodyPage"]}>
					<div className={styles["FPasswordContainer"]}>
						...
						<form className={styles["ForgotPasswordForm"]} onSubmit={handleSubmit} noValidate>
							<input className={styles["inputs"]} type="password" name='password' value={data.password} onChange={handleChange} placeholder="enter a password" />
							{errors.password && <span>{errors.password}</span>}
							<input className={styles["inputs"]} type="password" name='confirmPassword' value={data.confirmPassword} onChange={handleChange} placeholder="confirm your password" />
